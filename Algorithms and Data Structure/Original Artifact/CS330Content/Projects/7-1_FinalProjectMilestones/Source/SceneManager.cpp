...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/dark-cloth-1024x1024.jpg",
		"fabric");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.direction", 0.0f, 10.0f, 0.0f);
	...
	// Point Light 1 
	m_pShaderManager->setVec3Value("pointLights[0].position", 4.0f, 2.5f, 6.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 0.0f, 0.0f, 0.0f);
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", 1.5f, 1.2f, 0.3f);   
	m_pShaderManager->setVec3Value("pointLights[0].specular", 1.5f, 1.2f, 0.3f);  
	m_pShaderManager->setBoolValue("pointLights[0].bActive", true);

	// Point Light 2 
	m_pShaderManager->setVec3Value("pointLights[1].position", -2.0f, 3.0f, 4.0f);
...
void SceneManager::RenderScene()
{
	...
	// 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 0.5f, 2.2f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.1f, 0.25f, 8.0f);
	...
	// set the XYZ rotation for the mesh
	XrotationDegrees = 0.0f;
	YrotationDegrees = -34.0f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 0.00001f, 9.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.11f, 0.00001f, 8.2f);
	...
	/****************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.5f, 0.5f, 0.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.6f, 0.00001f, 8.26f);
	...
	// set the XYZ rotation for the mesh
	XrotationDegrees = 0.0f;
	YrotationDegrees = -20.5f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.2f, 0.00001f, 7.57f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 0.001f, 8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.0f, 0.001f, -6.0f);
	...
	/****************************************************************/
		...
		// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.3f, 0.2f, 2.3f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 2.0f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.0f, 1.001f, 6.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(18.0f, 0.2f, 12.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, 0.3f, -5.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(13.0f, 0.3f, -5.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, 0.3f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(12.4225f, 0.3f, 1.0f);
